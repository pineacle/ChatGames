package me.pineacle.chatgames.utils;
...
public class StringUtils {
    ...
    public static String scramble(String word) {
        List<String> words = Arrays.asList(word.split(" ")).stream().map(StringUtils::scrambleWord).collect(Collectors.toList());
        StringBuilder sb = new StringBuilder();
        for (String scrambled : words) {
            sb.append(scrambled + " ");
        }
